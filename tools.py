...
class JbHiFi:
    ...
    def allProductLinks(self):
        with sync_playwright() as p:
            ...
            for clicks in range (1, int(total_results)+20):  # Since I am unable to figure out the total number of pages, I just added the extra 20 for just a safey measure. The loop is going to break playwright get the timeouterror on click load more button.
                try:
